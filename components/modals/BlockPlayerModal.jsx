    ...
    <div className="text-white">
      {!showBlock ? (
        <div
          ...
          } absolute left-1/2  top-1/2 transform -translate-x-1/2 -translate-y-1/2  bg-Background    z-[100]`}
        >
          <div>
            <button
        ...
        <div
          className={`w-[75%] sm:w-[60%] md:w-[55%] lg:w-[50%] absolute left-1/2  top-1/2 transform -translate-x-1/2 -translate-y-1/2  bg-Background    z-[100]`}
        >
